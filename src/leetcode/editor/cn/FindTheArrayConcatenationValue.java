...
//</ul>
//
//<div><div>Related Topics</div><div><li>数组</li><li>双指针</li><li>模拟</li></div></div><br><div><li>👍 12</li><li>👎 0</li></div>

package leetcode.editor.cn;

/**
 * @author wangzhiheng
 * @date 2023-10-12 08:21:46
 */
public class FindTheArrayConcatenationValue {
    ...
    class Solution {
        public long findTheArrayConcVal(int[] nums) {
            ...
            long res = 0;
            while (l < r) {
                res += Integer.parseInt(nums[l] + "" + nums[r]);
                l++; r--;
            }
            if (l == r) {
                res += nums[l];
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.findTheArrayConcVal(
