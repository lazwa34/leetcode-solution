...
//</ul>
//
//<div><div>Related Topics</div><div><li>脑筋急转弯</li><li>数组</li><li>前缀和</li><li>排序</li></div></div><br><div><li>👍 29</li><li>👎 0</li></div>
...
public class MovementOfRobots {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.sumDistance(
                new int[]{-2,0,2}, "RLL", 3
        ));
    }
}