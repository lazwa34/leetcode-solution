...
//</ul>
//
//<div><div>Related Topics</div><div><li>数组</li><li>排序</li></div></div><br><div><li>👍 44</li><li>👎 0</li></div>
...
public class FilterRestaurantsByVeganFriendlyPriceAndDistance {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.filterRestaurants(
                new int[][]{
                        {1, 4, 1, 40, 10},
                        {2, 8, 0, 50, 5},
                        {3, 8, 1, 30, 4},
